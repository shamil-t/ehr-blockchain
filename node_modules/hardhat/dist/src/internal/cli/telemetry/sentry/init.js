...
import { applySdkMetadata, createStackParser, functionToStringIntegration, initAndBind, linkedErrorsIntegration, nodeStackLineParser, ServerRuntimeClient, stackParserFromStackParserOptions, } from "@sentry/core";
...
export function init(options) {
    ...
    initAndBind(ServerRuntimeClient, sentryOptions);
}
