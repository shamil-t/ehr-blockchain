...
import { greaterThanOrEqual, lowerThan, parseVersion, } from "@nomicfoundation/hardhat-utils/fast-semver";
...
export function hasOfficialArm64Build(version) {
    ...
    if (parsed === undefined) {
        throw new HardhatError(HardhatError.ERRORS.CORE.SOLIDITY.INVALID_SOLC_VERSION, { version });
    }
...
export function hasArm64MirrorBuild(version) {
    ...
    return (greaterThanOrEqual(parsed, FIRST_ARM64_MIRROR_SOLC_VERSION) &&
