import type { ImportResolutionError, NpmRootResolutionError, ProjectRootResolutionError, UserRemappingError } from "../../../../../types/solidity/errors.js";
import type { NpmPackageResolvedFile, ProjectResolvedFile, ResolvedFile, ResolvedNpmPackage } from "../../../../../types/solidity/resolved-file.js";
 ...
 */
export declare enum UserRemappingType {
    LOCAL = "LOCAL",
    NPM = "NPM"
}
/**
 ...
 */
export type ResolvedUserRemapping = LocalUserRemapping | ResolvedNpmUserRemapping;
/**
...
export interface RemappedNpmPackagesGraph {
     ...
     */
    resolveDependencyByInstallationName(from: ResolvedNpmPackage, installationName: InstallationName): Promise<undefined | {
     ...
     */
    selectBestUserRemapping(from: ResolvedFile, directImport: string): Promise<Result<Remapping | undefined, UserRemappingError[]>>;
    /**
...
export interface RemappedNpmPackagesGraphJson {
    ...
    readonly packageByInputSourceNameRoot: Readonly<Record<string, ResolvedNpmPackage>>;
    readonly installationMap: Readonly<Record<string, Readonly<Record<InstallationName, {
        readonly package: ResolvedNpmPackage;
        readonly generatedRemapping: Remapping;
    }>>>>;
    readonly userRemappingsPerPackage: Record<string, ReadonlyArray<ResolvedUserRemapping | UnresolvedNpmUserRemapping>>;
    readonly generatedRemappingsIntoNpmFiles: Readonly<Record<string, Readonly<Record<string, Remapping>>>>;
}
/**
