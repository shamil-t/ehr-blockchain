 ...
 */
export function fsPathToSourceNamePath(fsPath) {
    if (path.sep === "/") {
        return fsPath;
    }
 ...
 * be used outside of the resolver.
 */
export function sourceNamePathToFsPath(sourceNamePath) {
    if (path.sep === "/") {
 ...
 */
export function sourceNamePathJoin(...parts) {
    return fsPathToSourceNamePath(path.join(...parts));
}
//# sourceMappingURL=source-name-utils.js.map