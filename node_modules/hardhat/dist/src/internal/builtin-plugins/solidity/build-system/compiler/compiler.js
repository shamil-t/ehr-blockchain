...
import { greaterThanOrEqual, parseVersion, } from "@nomicfoundation/hardhat-utils/fast-semver";
import { mkdtemp, readJsonFileAsStream, remove, } from "@nomicfoundation/hardhat-utils/fs";
import { createNonClosingWriter } from "@nomicfoundation/hardhat-utils/stream";
const NO_IMPORT_CALLBACK_MIN_VERSION = [0, 8, 22];
const BASE_PATH_MIN_VERSION = [0, 6, 9];
/**
...
export class NativeCompiler {
    ...
    async compile(input) {
        ...
        if (this.version !== undefined) {
            ...
            if (parsed === undefined) {
                throw new HardhatError(HardhatError.ERRORS.CORE.SOLIDITY.INVALID_SOLC_VERSION, { version: this.version });
            }
