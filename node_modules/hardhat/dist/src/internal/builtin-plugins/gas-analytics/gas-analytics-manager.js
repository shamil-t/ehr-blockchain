...
const gasStatsLog = createDebug("hardhat:core:gas-analytics:gas-analytics-manager:gas-stats");
    ...
    _generateGasStatsReport(gasStatsByContract) {
        ...
        for (const { userFqn, proxyLabel, stats: contractGasStats, } of sortedContracts) {
            rows.push({
                ...
                subtitle: proxyLabel !== undefined ? styleText("cyan", proxyLabel) : undefined,
            });
