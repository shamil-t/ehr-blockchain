 ...
 */
export function normaliseCandidateSingle(input: ImportCandidate, normaliseContent: (content: ToContent) => Promise<AsyncIterable<Uint8Array>>): AsyncGenerator<import("ipfs-unixfs-importer/dist/src/types.js").ImportCandidate, void, unknown>;
