...
export type ProviderRpcErrorCode = 4001 | 4100 | 4200 | 4900 | 4901 | 4902 | 5700 | 5710 | 5720 | 5730 | 5740 | 5750 | 5760 | 7000;
/**
 ...
 */
export type WalletConnectSessionSettlementErrorType = WalletConnectSessionSettlementError & {
    code: 7000;
    name: 'WalletConnectSessionSettlementError';
};
export declare class WalletConnectSessionSettlementError extends ProviderRpcError {
    static code: 7000;
    constructor(cause: Error);
}
/**
