...
import { type EstimateOperatorFeeParameters, type EstimateOperatorFeeReturnType } from '../actions/estimateOperatorFee.js';
...
export type PublicActionsL2<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     * })
     */
    estimateOperatorFee: <chainOverride extends Chain | undefined = undefined>(parameters: EstimateOperatorFeeParameters<chain, account, chainOverride>) => Promise<EstimateOperatorFeeReturnType>;
    /**
