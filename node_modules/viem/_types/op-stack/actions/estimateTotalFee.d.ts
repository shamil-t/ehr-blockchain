...
import { type EstimateOperatorFeeErrorType, type EstimateOperatorFeeParameters } from './estimateOperatorFee.js';
export type EstimateTotalFeeParameters<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, chainOverride extends Chain | undefined = Chain | undefined> = EstimateL1FeeParameters<chain, account, chainOverride> & EstimateOperatorFeeParameters<chain, account, chainOverride>;
export type EstimateTotalFeeReturnType = bigint;
export type EstimateTotalFeeErrorType = RequestErrorType | PrepareTransactionRequestErrorType | EstimateL1FeeErrorType | EstimateOperatorFeeErrorType | EstimateGasErrorType | GetGasPriceErrorType | ErrorType;
/**
