 ...
 */
export function createRmAll(client: import('../../lib/core').Client): (query: import("ipfs-core-types/src/pin/remote").Query & import("ipfs-core-types").AbortOptions & import("../../types").HTTPClientExtraOptions) => Promise<void>;
