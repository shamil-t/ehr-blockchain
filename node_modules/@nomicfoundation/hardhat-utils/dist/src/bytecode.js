...
import { applyBytecodeReplacements, checkAmbiguousOrUnnecessaryLinks, checkMissingLibraryAddresses, checkOverlappingLibraryNames, checkProvidedLibraryAddresses, } from "./internal/bytecode.js";
/**
...
export function linkBytecode(artifact, libraries) {
    ...
    return getPrefixedHexString(applyBytecodeReplacements(bytecode, replacements));
}
