...
import { equals, greaterThanOrEqual, lowerThan, lowerThanOrEqual, parseVersion, } from "@nomicfoundation/hardhat-utils/fast-semver";
// Etherscan only supports solidity versions higher than or equal to v0.4.11.
// See https://etherscan.io/solcversions
const MIN_SUPPORTED_SOLC_VERSION = [0, 4, 11];
 ...
 */
export function filterVersionsByInferred(versions, inferred) {
    return versions.filter((version) => {
        ...
        switch (inferred.type) {
            ...
            case "between":
                return (greaterThanOrEqual(parsed, inferred.min) &&
