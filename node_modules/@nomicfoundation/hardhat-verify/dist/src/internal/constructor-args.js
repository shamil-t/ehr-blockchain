...
export async function encodeConstructorArgs(abi, constructorArgs, contract) {
    ...
    try {
        ...
        if (expectedConstructorArgs.length === constructorArgs.length) {
            constructorArgs.forEach((arg, i) => {
                ...
                if (expectedArg.type === "string" && typeof arg !== "string") {
                    throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.GENERAL.INVALID_CONSTRUCTOR_ARGUMENT_TYPE, {
                        value: String(arg),
        ...
        if (isInvalidConstructorArgsLengthError(error)) {
            throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.GENERAL.INVALID_CONSTRUCTOR_ARGUMENTS_LENGTH, {
                contract,
        ...
        if (isConstructorArgOverflowError(error)) {
            throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.GENERAL.CONSTRUCTOR_ARGUMENT_OVERFLOW, {
                value: String(error.value),
            });
        }
        ...
        throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.GENERAL.CONSTRUCTOR_ARGUMENTS_ENCODING_FAILED, {
            contract,
            reason,
        });
    }
