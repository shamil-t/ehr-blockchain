...
export async function resolveConstructorArgs(constructorArgs, constructorArgsPath) {
    ...
    if (hasArgs && hasPath) {
        throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.VALIDATION.MUTUALLY_EXCLUSIVE_CONSTRUCTOR_ARGS);
    }
    ...
    if (!("default" in importedConstructorArgs) ||
        ...
        throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.VALIDATION.INVALID_CONSTRUCTOR_ARGS_MODULE_EXPORT, {
            constructorArgsPath,
        });
    }
...
export async function resolveLibraries(librariesPath) {
    ...
    if (!("default" in importedLibraries) ||
        ...
        throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.VALIDATION.INVALID_LIBRARIES_MODULE_EXPORT, {
            librariesPath,
        });
    }
