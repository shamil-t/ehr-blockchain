 ...
 */
export function isValidIgnitionIdentifier(identifier) {
 ...
 */
export function isValidSolidityIdentifier(identifier) {
 ...
 */
export function isValidFunctionOrEventName(functionName) {
 ...
 */
export function isValidContractName(contractName) {
