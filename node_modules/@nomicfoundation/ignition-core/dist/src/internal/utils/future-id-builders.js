 ...
 */
export function toContractFutureId(moduleId, userProvidedId, contractOrLibraryName) {
 ...
 * @returns the future id
 */
export function toCallFutureId(moduleId, userProvidedId, contractModuleId, contractId, functionName) {
    if (userProvidedId !== undefined) {
        return `${moduleId}${MODULE_SEPARATOR}${userProvidedId}`;
    }
 ...
 * @returns the future id
 */
export function toEncodeFunctionCallFutureId(moduleId, userProvidedId, contractModuleId, contractId, functionName) {
    if (userProvidedId !== undefined) {
        return `${moduleId}${MODULE_SEPARATOR}${userProvidedId}`;
    }
    if (moduleId === contractModuleId) {
 ...
 * @returns the future id
 */
export function toReadEventArgumentFutureId(moduleId, userProvidedId, contractName, eventName, nameOrIndex, eventIndex) {
 ...
 * @returns the future id
 */
export function toSendDataFutureId(moduleId, userProvidedId) {
    return `${moduleId}${MODULE_SEPARATOR}${userProvidedId}`;
}
