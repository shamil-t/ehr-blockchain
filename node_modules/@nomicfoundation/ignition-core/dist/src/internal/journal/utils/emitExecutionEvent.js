import { ExecutionEventNetworkInteractionType, ExecutionEventResultType, ExecutionEventType, } from "../../../types/execution-events.js";
...
export async function emitExecutionEvent(message, executionEventListener) {
    switch (message.type) {
