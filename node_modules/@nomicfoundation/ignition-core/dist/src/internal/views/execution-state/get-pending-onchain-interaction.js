 ...
 */
export function getPendingOnchainInteraction(exState) {
    ...
    assertIgnitionInvariant(interaction !== undefined, `Unable to find network interaction for ${exState.id} when trying to get pending onchain interaction`);
