...
import type { AccountRuntimeValue, ArgumentType, ModuleParameterRuntimeValue, RuntimeValue, SolidityParameterType } from "../../types/module.js";
...
export declare function validateAccountRuntimeValue(arv: AccountRuntimeValue, accounts: string[]): HardhatError[];
