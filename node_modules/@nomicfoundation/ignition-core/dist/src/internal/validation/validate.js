...
async function _validateFuture(future, artifactLoader, deploymentParameters, accounts) {
    switch (future.type) {
        case FutureType.CONTRACT_DEPLOYMENT:
            return await validateArtifactContractDeployment(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.LIBRARY_DEPLOYMENT:
            return await validateArtifactLibraryDeployment(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.CONTRACT_AT:
            return await validateArtifactContractAt(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.NAMED_ARTIFACT_CONTRACT_DEPLOYMENT:
            return await validateNamedContractDeployment(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.NAMED_ARTIFACT_LIBRARY_DEPLOYMENT:
            return await validateNamedLibraryDeployment(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.NAMED_ARTIFACT_CONTRACT_AT:
            return await validateNamedContractAt(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.CONTRACT_CALL:
            return await validateNamedContractCall(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.STATIC_CALL:
            return await validateNamedStaticCall(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.ENCODE_FUNCTION_CALL:
            return await validateNamedEncodeFunctionCall(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.READ_EVENT_ARGUMENT:
            return await validateReadEventArgument(future, artifactLoader, deploymentParameters, accounts);
        case FutureType.SEND_DATA:
            return await validateSendData(future, artifactLoader, deploymentParameters, accounts);
    }
}
