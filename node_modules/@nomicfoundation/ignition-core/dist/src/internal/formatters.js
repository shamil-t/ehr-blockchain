 ...
 */
export function formatExecutionError(result) {
    switch (result.type) {
 ...
 */
export function formatFailedEvmExecutionResult(result) {
    switch (result.type) {
 ...
 */
export function formatCustomError(errorName, args) {
 ...
 * @public
 */
export function formatSolidityParameter(param) {
