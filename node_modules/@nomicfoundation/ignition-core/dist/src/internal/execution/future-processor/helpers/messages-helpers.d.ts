import type { DeploymentExecutionResult, CallExecutionResult, SendDataExecutionResult, StaticCallExecutionResult } from "../../types/execution-result.js";
import type { DeploymentExecutionState, CallExecutionState, SendDataExecutionState, StaticCallExecutionState } from "../../types/execution-state.js";
import type { DeploymentExecutionStateCompleteMessage, CallExecutionStateCompleteMessage, SendDataExecutionStateCompleteMessage, StaticCallExecutionStateCompleteMessage } from "../../types/messages.js";
/**
