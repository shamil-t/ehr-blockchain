 ...
 * @public
 */
export function buildModule(moduleId, moduleDefinitionFunction) {
    if (typeof moduleId !== "string") {
        throw new HardhatError(HardhatError.ERRORS.IGNITION.MODULE.INVALID_MODULE_ID);
    }
    if (!isValidIgnitionIdentifier(moduleId)) {
        throw new HardhatError(HardhatError.ERRORS.IGNITION.MODULE.INVALID_MODULE_ID_CHARACTERS, {
            moduleId,
        });
    }
    if (typeof moduleDefinitionFunction !== "function") {
        throw new HardhatError(HardhatError.ERRORS.IGNITION.MODULE.INVALID_MODULE_DEFINITION_FUNCTION);
    }
...
function _checkForDuplicateModuleIds(ignitionModule) {
    ...
    throw new HardhatError(HardhatError.ERRORS.IGNITION.MODULE.DUPLICATE_MODULE_ID, {
