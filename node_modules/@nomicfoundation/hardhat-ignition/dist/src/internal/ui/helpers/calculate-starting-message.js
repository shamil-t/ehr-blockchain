 ...
 */
export function calculateStartingMessage({ moduleName, deploymentDir, }) {
    const warningMessage = styleText(["yellow", "bold"], `You are running Hardhat Ignition against an in-process instance of Hardhat Network.
