 ...
 */
export function resolveDeploymentId(givenDeploymentId, chainId) {
    if (givenDeploymentId !== undefined &&
        !_isValidDeploymentIdentifier(givenDeploymentId)) {
        throw new HardhatError(HardhatError.ERRORS.IGNITION.INTERNAL.INVALID_DEPLOYMENT_ID, {
 ...
 * */
export function _isValidDeploymentIdentifier(identifier) {
